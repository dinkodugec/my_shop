...
<?php 
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['submit']) ) { 
        $updateCmr = $cmr->customerUpdate($_POST, $cmrId);// create method in our User.php Class 
    }
?> 
 ...
 <div class="main">
  ...
  <?php 
   ...
   $getdata = $cmr->getCustomerData($id);  // create this method in our User.php class and load data
   if ($getdata) {
